local startify_quotes = {
  ...
  { "A test is the first user of your code.", "Use its feedback to guide you what to do." },
  ...
  { "Always take small steps.", "Check the feedback and adjust before proceeding." },
  ...
  { "Failing test before fixing code", "Create a focused test that reveals the bug before you try fixing it." },
  ...
  { "Tell, don't ask.", "Don't get values from an object, transform them, and stick them back.", "Make the object do the work." },
