...
--     "4. The first line should ideally be no longer than 50 characters, and the body should be restricted to 72 characters.",
...
--     "",
--     "Use its feedback to guide you what to do.",
--     "",
...
--     "",
--     "Check the feedback and adjust before proceeding.",
--     "",
--     "- The Pragmatic Programmer",
--   },
...
--   {
--     "Code isn't written in stone, it's written in Christmas lights. Put away all nice and neat and the next time you pull it out it's a knitted mess of eldritch make.",
--     "",
--     "- Unknown",
--   },
...
--     "",
--     "- Kernighan's law (Brian Kernighan)",
--   },
--   {
...
--   },
--   {
--     "Defer abstractions as late as possible. The more you learn about the problem space the better the abstraction will be. Premature abstractions are often worse than no abstraction.",
--     "",
--     "- pydry (reddit)",
--   },
...
--   },
--   {
--     "Every application has an inherent amount of complexity that cannot be removed or hidden. Instead, it must be dealt with, either in product development or user interaction.",
--     "",
...
--     "",
--     "Create a focused test that reveals the bug before you try fixing it.",
--     "",
--     "- The Pragmatic Programmer",
--   },
--   {
...
--   {
--     "How much time do you invest in cleaning it? Roughly the same amount of time it took you to write it. And that's the problem - nobody wants to put that effort in. Because they think they're done when it works. You're not done when it works! You're done when it's right.",
--     "",
--     "- Robert C. Martin",
--   },
--   {
...
--   },
--   {
--     "If you hand me code that works perfectly but I can't understand it, then as soon as the requirements change that code is useless. On the other hand, if you give me code that _does not work_ but I can understand it, I can make it work.",
--     "",
--     "It is much more important that your peers can understand the code that you write than the computer can understand the code that you write.",
--     "",
--     "- Robert C. Martin",
--   },
...
--   {
--     'In science it often happens that scientists say, "You know that\'s a really good argument; my position is mistaken" ...and you never hear that old view from them again... It happens every day. I cannot recall the last time something like that happened in politics or religion.',
--     "",
--     "- Carl Sagan",
--   },
...
--   },
--   {
--     "Keep related data and behavior in one place. Spin off non related information into another class. Move Data Close to Behavior.",
--     "",
--     "- Object-Oriented Design Heuristics",
--   },
...
--     "",
--     "- Sophie Wilson, Early designer of ARM instruction set and lead dev of BBC BASIC",
--   },
--   { 'Patterns mean "I have run out of language." ', "", "- Rich Hickey" },
--   {
--     "Paying attention to how things work without thinking about how they fail is a recipe for disaster.",
--     "",
--     "- Cory Doctorow",
--   },
--   {
...
--     "",
--     "We're going to ask you to think about your own reactions, behaviors, and attitudes - and in return, we hope you gain some real insight into how to become a more efficient and successful software engineer who spends less energy dealing with people-related problems and more time writing great code.",
--     "",
--     "- Titus Winters",
--   },
--   {
...
--   {
--     "Programming is a good job if you want to spend all of your time at the absolute limit of your capacity to understand things.",
--     "",
--     "- @Pentadact",
--   },
...
--   {
--     "Pushing [a developer] for a lower dev estimate is like negotiating better weather with a meteorologist.",
--     "",
...
--   {
--     "Some folks talk about ending the day with a clean check in.",
--     "",
--     "I'm increasingly finding it better to end with a failing test; it helps me regain context the next morning.",
--     "",
--     "- Dave Thomas",
--   },
--   {
...
--   },
--   {
--     "Stop yourself every time you say I prefer. Your opinion doesn’t matter to anyone, even yourself. Look at things objectively.",
--     "",
--     "Give yourself a refactor/change budget. Prioritize and be pragmatic.",
--     "",
--     "- National_Count_4196 (reddit)",
--   },
...
--     "Tell, don't ask.",
--     "",
--     "Don't get values from an object, transform them, and stick them back. Make the object do the work.",
--     "",
--     "- The Pragmatic Programmer",
--   },
--   {
...
--   {
--     "The Programmer's Creed: We do these things not because they are easy, but because we thought they were going to be easy.",
--     "",
--     "- @Pinboard",
--   },
--   {
...
--   },
--   {
--     "The fact that you got it working is only half the job. Once the code works, that's when you have to clean it. No one writes clean code first.",
--     "",
--     "- Robert C. Martin",
--   },
--   {
...
--   {
--     "Why do we make the mess? What drives us to make the mess in the first place? Because we want to go fast.",
--     "",
--     "- Robert C. Martin",
--   },
...
--     vim.g["startify_custom_header_quotes"] = my_startify_quotes
